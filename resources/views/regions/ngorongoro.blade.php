    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100">
                ...
                <p class="text-slate-600 font-medium leading-relaxed">Year-round wildlife viewing. June–October offers clearer skies; January–March is lush with excellent photography and birdlife.</p>
            </div>
            <div class="bg-emerald-50 p-10 rounded-[2.5rem] border border-emerald-100">
                ...
                <p class="text-emerald-900/80 font-medium leading-relaxed">Crater game drive, rhino tracking opportunities, scenic viewpoints on the rim, and cultural visits in the highlands.</p>
            </div>
            <div class="bg-slate-900 p-10 rounded-[2.5rem] border border-slate-800 text-white">
                ...
                <p class="text-slate-300 font-medium leading-relaxed">Drive from Arusha via Lake Manyara (Northern Circuit). Many itineraries include Ngorongoro between Tarangire/Manyara and Serengeti.</p>
            </div>
        </div>
    </div>
</section>
