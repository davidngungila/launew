    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div class="lg:col-span-5">
                @include('regions.partials.gallery-slider', ['gallery' => $gallery, 'title' => 'Arusha NP Gallery', 'eyebrow' => 'View more images'])
                <div class="h-10"></div>
        ...
        <div class="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100">
                ...
                <p class="text-slate-600 font-medium leading-relaxed">Year-round. Dry season (June–October) offers clear views of Meru. Green season brings lush forest and beautiful light for photos.</p>
            </div>
            <div class="bg-emerald-50 p-10 rounded-[2.5rem] border border-emerald-100">
                <h4 class="text-emerald-900 font-black mb-3 flex items-center gap-2 italic"><i class="ph ph-person-simple-hike text-2xl"></i> Top activities</h4>
                <p class="text-emerald-900/80 font-medium leading-relaxed">Walking safari, canoeing on Momella Lakes, colobus monkeys, and scenic viewpoints—perfect for active travelers.</p>
            </div>
            <div class="bg-slate-900 p-10 rounded-[2.5rem] border border-slate-800 text-white">
                ...
                <p class="text-slate-300 font-medium leading-relaxed">Very close to Arusha city and Kilimanjaro Airport. Ideal as a day trip or the first/last stop before a longer Northern Circuit safari.</p>
            </div>
        </div>
    </div>
</section>
