    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div class="lg:col-span-5">
                @include('regions.partials.gallery-slider', ['gallery' => $gallery, 'title' => 'Zanzibar Gallery', 'eyebrow' => 'View more images'])
                <div class="h-10"></div>
        ...
        <div class="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100">
                ...
                <p class="text-slate-600 font-medium leading-relaxed">June–October for dry, sunny beach days. December–February is also excellent. April–May is the main rainy season.</p>
            </div>
            <div class="bg-emerald-50 p-10 rounded-[2.5rem] border border-emerald-100">
                ...
                <p class="text-emerald-900/80 font-medium leading-relaxed">Snorkeling, diving, spice tours, dhow cruises, and Stone Town history walks with local guides.</p>
            </div>
            <div class="bg-slate-900 p-10 rounded-[2.5rem] border border-slate-800 text-white">
                ...
                <p class="text-slate-300 font-medium leading-relaxed">Fly from Arusha/Serengeti to Zanzibar, or connect via Dar es Salaam. Perfect as a safari + beach extension.</p>
            </div>
        </div>
    </div>
</section>
