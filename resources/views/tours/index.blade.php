    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-between mb-16 gap-8 bg-slate-50 p-6 rounded-3xl border border-slate-100">
            ...
            <div class="text-slate-500 text-sm">
                Showing <span class="text-slate-900 font-bold font-serif">12</span> safari packages
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="group bg-white rounded-[2rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-100">
                <div class="relative h-64 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1516426122078-c23e76319801?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Safari" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                ...
                <div class="p-8">
                    <div class="flex items-center gap-3 text-xs font-bold text-emerald-600 uppercase tracking-widest mb-4">
                        <span class="flex items-center gap-1"><i class="ph ph-map-pin"></i> Serengeti</span>
                        <span class="w-1 h-1 bg-slate-300 rounded-full"></span>
                        <span class="flex items-center gap-1"><i class="ph ph-clock"></i> 5 Days</span>
                    </div>
                    <h3 class="text-2xl font-bold text-slate-900 mb-4 group-hover:text-emerald-600 transition-colors">Wild Western Corridor</h3>
                    <p class="text-slate-500 text-sm leading-relaxed mb-8 line-clamp-2">A majestic journey through the remote western corridor of the Serengeti, perfect for spotting the big cats.</p>
                    
                    <div class="flex items-center justify-between">
                        <div>
                            <span class="text-slate-400 text-[10px] font-bold uppercase tracking-widest block mb-1">Per Person</span>
                            <span class="text-2xl font-bold text-slate-900">$1,480</span>
                        </div>
                        <a href="/tours/1" class="inline-flex items-center gap-2 bg-slate-900 text-white px-6 py-3 rounded-2xl font-bold hover:bg-emerald-600 transition-colors">
