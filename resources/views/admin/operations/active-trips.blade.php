...
<div class="space-y-8">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Active Trips</h1>
            <p class="text-slate-500 font-medium">Confirmed bookings that should be in-progress based on travel date</p>
        </div>
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.operations.upcoming') }}" class="px-5 py-2.5 bg-white border border-slate-200 text-slate-700 font-bold rounded-xl hover:bg-slate-50 transition-all shadow-sm">Upcoming</a>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-8 py-12 text-center">
                                <p class="text-slate-400 font-medium">No active trips found</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
