...
<div class="space-y-8">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Assign Guides</h1>
            <p class="text-slate-500 font-medium">Bookings that require a guide assignment</p>
        </div>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-5">
                                <div class="text-[10px] font-black text-slate-400 uppercase tracking-widest space-y-1">
                                    <div>Guide: <span class="text-red-600">Unassigned</span></div>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-8 py-12 text-center">
                                <p class="text-slate-400 font-medium">No guide assignments pending</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
