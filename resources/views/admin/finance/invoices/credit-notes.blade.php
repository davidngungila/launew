...
<div class="space-y-8">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Credit Notes</h1>
            <p class="text-slate-500 font-medium">Currently mapped to cancelled bookings (credit-note workflow comes next)</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
            <div class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Cancelled Bookings</div>
            <div class="mt-3 text-3xl font-black text-slate-900">{{ $stats['cancelled'] ?? 0 }}</div>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-10 text-center text-slate-400 font-bold">No cancelled bookings found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
